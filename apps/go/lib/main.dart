  ...
  final GoRouter _router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      StatefulShellRoute(
        ...
        builder: (BuildContext context, GoRouterState state,
            StatefulNavigationShell navigationShell) {
          /// Builder implementation for the top shell, using a custom branch
          /// container, like with TabbedRootScreen above.
          return navigationShell;
        },
        navigatorContainerBuilder: (BuildContext context,
                StatefulNavigationShell navigationShell,
        ...
        //      StatefulNavigationShell navigationShell) {
        //   return NoTransitionPage<dynamic>(child: navigationShell);
        // },
      ),
    ],
  );
