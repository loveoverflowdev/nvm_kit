/*
"fields":"id,boardName,description,
widgetRoles{id,name,shortName,description},
widgetProgresses{id,progress,progressTitle,description,color,icon},
createdBy,updatedBy,createdAt,updatedAt,createdByUser{id,fullName},updatedByUser"
*/
